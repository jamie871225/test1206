...
<head>
    ...
    .title p{
        border-left:5px solid rgb(253, 244, 229);
        padding-left:15px;
        font-size:16px;
        font-weight:lighter;
    ...
    .hrtop{
        width:80%;
        border:0px;
        border-top:8px solid rgb(65, 163, 255);
        position:relative;
        top:-12px;
    }
    .hrbottom{
...
<body>
    <div class="title">
        <div>
            <img class="titleimg" src="jingyuhead.png" alt="官靖瑜" title="可愛的靖瑜">
        </div>
        <div class="titletext">
    ...
    <div class="floatimg">
        <img src="jingyuhead.png" alt="官靖瑜" title="可愛的靖瑜">
    </div>
</body>
</html>
